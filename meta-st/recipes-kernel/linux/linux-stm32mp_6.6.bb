...
KERNEL_CONFIG_FRAGMENTS:append = " ${UNPACKDIR}/fragments/${LINUX_VERSION}/fragment-10-obmc-reduction.config"
KERNEL_CONFIG_FRAGMENTS:append = " ${UNPACKDIR}/fragments/${LINUX_VERSION}/fragment-11-obmc-addons.config"
...
SRC_URI += "file://${LINUX_VERSION}/fragment-10-obmc-reduction.config;subdir=fragments"
SRC_URI += "file://${LINUX_VERSION}/fragment-11-obmc-addons.config;subdir=fragments"
...
SRC_URI:class-devupstream += "file://${LINUX_VERSION}/fragment-10-obmc-reduction.config;subdir=fragments"
SRC_URI:class-devupstream += "file://${LINUX_VERSION}/fragment-11-obmc-addons.config;subdir=fragments"
